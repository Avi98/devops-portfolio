    ...
    features: [
      {
        id: "technical-seo",
        title: "Technical SEO",
        icon: "/icons/orange/seo-technical.svg",
        type: "text",
      },
      {
        id: "search-engine-audit",
        title: "Search Engine Audit",
        icon: "/icons/orange/seo-audit.svg",
        type: "text",
      },
      {
        id: "keyword-research",
        title: "Keyword Research",
        icon: "/icons/orange/seo-keyword.svg",
        type: "text",
      },
      {
        id: "seo-strategy",
        title: "SEO Strategy",
        icon: "/icons/orange/seo-strategy.svg",
        type: "text",
      },
      {
        id: "organic-marketing",
        title: "Organic Marketing",
        icon: "/icons/orange/seo-organic.svg",
        type: "text",
      },
      {
        id: "measuring-reporting",
        title: "Measuring + Reporting",
        icon: "/icons/orange/seo-measuring.svg",
        type: "text",
      },
    ],
